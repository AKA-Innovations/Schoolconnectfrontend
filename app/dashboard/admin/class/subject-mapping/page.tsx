...
import { Plus, Pencil, Trash2, Search, X, Save, BookOpen, Users } from 'lucide-react';
    ...
    <div className="p-6 lg:p-8 space-y-6 animate-in fade-in duration-500">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Assign teachers to subjects for each class/section</p>
        </div>
